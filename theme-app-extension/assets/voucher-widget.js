window.addEventListener('load', function () { 
    ...
    // let api_url = 'https://1681-114-134-24-55.in.ngrok.io/cre2/public';
    ...
    if (window.location.href.indexOf("/cart") > -1) {
        ...
        if(dis_data) {
            ...
            if(discount_data) {
                ...
                var span_id_new = document.getElementById('void_text_id_new');
                span_id_new.innerHTML = ' Void the old coupon first to add new voucher values.';
        ...
        document.getElementById('widget-custom-number-voucher').addEventListener('upStep', function(e) {
            console.log("upstep");
        });
    ...
    function checkDifference(data_amount = 0) {
        ...
        console.log("all_valid new",all_valid);
        ...
        console.log("is_bt_redeemed",is_bt_redeemed);
        console.log("eligible_tot",eligible_tot);
        ...
        if(parseFloat(cart_tot.toFixed(2)) > parseFloat(eligible_tot)) {
            ...
            if(is_bt_redeemed == 1) {
                console.log("here3");
                console.log("cart_tot.toFixed(2)",cart_tot.toFixed(2));
